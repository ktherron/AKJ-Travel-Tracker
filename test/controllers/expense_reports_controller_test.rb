...
class ExpenseReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_report" do
    assert_difference('ExpenseReport.count') do
      post expense_reports_url, params: { expense_report: { Department: @expense_report.Department, First_name: @expense_report.First_name, Flight: @expense_report.Flight, Hotel: @expense_report.Hotel, Last_Name: @expense_report.Last_Name, Mileage: @expense_report.Mileage, Other: @expense_report.Other, Transportation: @expense_report.Transportation, image_url: @expense_report.image_url } }
    end
  ...
  test "should update expense_report" do
    patch expense_report_url(@expense_report), params: { expense_report: { Department: @expense_report.Department, First_name: @expense_report.First_name, Flight: @expense_report.Flight, Hotel: @expense_report.Hotel, Last_Name: @expense_report.Last_Name, Mileage: @expense_report.Mileage, Other: @expense_report.Other, Transportation: @expense_report.Transportation, image_url: @expense_report.image_url } }
